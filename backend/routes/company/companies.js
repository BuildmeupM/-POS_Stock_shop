...
router.post('/', async (req, res) => {
  try {
    ...
    const defaultAccounts = [
      ...
      ['2120', 'ภาษีขาย (VAT) ค้างจ่าย', 'liability'],
      ['2130', 'ภาษีหัก ณ ที่จ่ายค้างจ่าย', 'liability'],
      ['2150', 'เจ้าหนี้ผู้ฝากขาย', 'liability'],
      ['2200', 'ภาษีมูลค่าเพิ่มค้างจ่าย', 'liability'],
      ['2300', 'ภาษีหัก ณ ที่จ่ายค้างจ่าย (เดิม)', 'liability'],
